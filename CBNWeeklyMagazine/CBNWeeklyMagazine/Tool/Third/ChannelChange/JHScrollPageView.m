...
- (JHScrollSegmentView *)segmentView {
    if (!_segmentView) {
        ...
        JHScrollSegmentView *segment = [[JHScrollSegmentView alloc] initWithFrame:CGRectMake(0, 64, self.bounds.size.width, 25*screen_Width/320) segmentStyle:self.segmentStyle titles:self.titlesArray titleDidClick:^(UILabel *label, NSInteger index) {
