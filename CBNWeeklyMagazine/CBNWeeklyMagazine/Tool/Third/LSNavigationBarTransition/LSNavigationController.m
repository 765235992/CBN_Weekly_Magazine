...
{
    [super viewDidLoad];
    [self.navigationBar setShadowImage:[[UIColor clearColor] colorImage]];
//self.navigationController.navigationBar.dk_barTintColorPicker = DKColorPickerWithKey(导航条默认背景颜色);
